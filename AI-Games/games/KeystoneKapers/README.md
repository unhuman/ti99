...
Harry runs in **side profile** -- legs scissored with the trailing foot kicked up behind, and **striped from shoulder to hem**, with the arms drawn as those same bands extended sideways (which is how the arcade does it, and what makes them read as arms). Symmetric legs are a front view, and they were why he read as facing the player however his head was drawn.
