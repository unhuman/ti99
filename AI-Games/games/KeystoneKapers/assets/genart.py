...
# Legs, stride 1.  Only rows 0-7 are used: the figure is 24 px, not 32.
KELLY_LEG1 = """
.....##..##.....
.....##..##.....
....###..###....
...
SPRITES = [
    ("spr_kelly", [KELLY_HAT, KELLY_FACE, KELLY_BODY,
                   KELLY_LEG1, KELLY_LEG2, KELLY_DHAT, KELLY_DFACE,
                   mirror(KELLY_HAT), mirror(KELLY_FACE), mirror(KELLY_BODY),
                   mirror(KELLY_LEG1), mirror(KELLY_LEG2),
                   mirror(KELLY_DHAT), mirror(KELLY_DFACE)],
     "Kelly RIGHT then LEFT: hat, face, tunic, leg1, leg2, duck-hat, "
     "duck-face. Patterns 0..52"),
    ("spr_harry", [HARRY_BODY, HARRY_FACE, HARRY_STRIPE,
                   HARRY_LEG1, HARRY_LEG2,
                   mirror(HARRY_BODY), mirror(HARRY_FACE),
                   mirror(HARRY_STRIPE),
                   mirror(HARRY_LEG1), mirror(HARRY_LEG2)],
     "Harry RIGHT then LEFT: white, face, stripes, leg1, leg2. "
     "Patterns 56..92"),
    ("spr_cart", [CART], "shopping cart -- jump it. Pattern 56"),
    ("spr_ball", [BALL], "beach ball -- jump it LOW, duck it HIGH. Pattern 60"),
    ("spr_radio", [RADIO], "cathedral radio, stationary. Pattern 64"),
    ("spr_plane", [PLANE_R, mirror(PLANE_R), PLANE_R2, mirror(PLANE_R2)],
     "toy biplane -- DUCK. The only thing that kills. Patterns 68,72"),
]
