...
""")
        ...
        emit(fh, "scan_col3", scol,
             "one 8-byte block per canvas row: %d px of GREY margin, then a "
             "3 px band of furniture GREY and a yellow floor line, per 4 px "
             "level, on dark green. The Kop and the crook are coloured PER "
             "CHARACTER at run time -- see scan_set" % SCAN_TOP)
        total += 24
