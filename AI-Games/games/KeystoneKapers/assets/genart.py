...
KELLY_DHAT = KELLY_DUCK_HAT     # helmet, BLACK -- slot 0, so it wins
KELLY_DFACE = KELLY_DUCK_FACE   # the face, skin
KELLY_DBODY = KELLY_DUCK_BODY   # the WHOLE body, head to heel, under both
