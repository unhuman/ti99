#!/usr/bin/env bash
#
# Build Ms. Pac-Man (CVBasic XB port) for the TI-99/4A.
#
#   compile (CVBasic) -> assemble (xas99) -> pack cartridge (linkticart)
#
# Output: src/mspac_8.bin  -- load directly in Classic99 or js99er.
#
...
NAME="mspac"
CARTNAME="MS PACMAN"          # shown on the TI cartridge menu (<=20 chars, uppercase)
