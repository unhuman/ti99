...
|-------|------|-------------------|
| 0–3 | flag F, 2×2 quadrants (TL TR BL BR) | yellow on tan |
| 4–7 | special flag S, 2×2 quadrants | red on tan |
| 8–11 | lucky flag L, 2×2 quadrants | white on tan |
...
rides the 16-px lane with 2 px of margin per side). 4 rotation frames shared by player and
enemies (recolored per sprite) + 2 explosion frames = 6 16×16 patterns (32 B each) in ROM.
