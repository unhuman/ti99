...
- **BANG is a graphic** (§9): a 4×3-char starburst with the lettering embedded, generated by
  `assets/genbang.py`. 6×3 was too big and 2×2 left the letters unreadable.
- **Flag values pop up** in a 2×2 box (§7) — the value over `x2` when the special is doubling it.
  ...
  The mini font lives in **TI bank 0** — gameplay reads it with bank 1 or 2 selected.
